...
const UserDashboard = () => {
  ...
  return (
    <UserdashboardLayout>
      {UserAdddressData &&
        UserAdddressData?.map((addressValueData) => {
          return (
            <>
              <section className=" bg-gray-100">
                <div className="flex mx-4">
                  <div className="flex flex-col items-start justify-start gap-4 w-1/2 ">
                    ...
                    <p className="text-base text-gray-400 flex items-start justify-start">
                      {formatDate(currentTime)}
                    </p>
                  </div>

                  <div className="w-1/2 flex items-center gap-4 justify-end px-10">
                    <div className="rounded-md p-2 flex flex-col md:flex-row gap-4">
                      <button
                        onClick={() =>
                ...
                <div className="flex flex-col items-start justify-start mt-10 w-auto  p-5 border border-gray-300 rounded-lg mx-4 mb-16">
                  ...
                  <div className="my-2 text-lg w-full rounded-lg flex justify-between items-center gap-4">
                    ...
                    <div className="my-2 text-lg w-1/2 rounded-lg flex flex-col justify-start items-start ">
                      ...
                      <span className="border  border-gray-300 p-2 w-full rounded-lg bg-white text-gray-400">
                        {lastName}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="faq">
                    ...
                    <label htmlFor="faq-a">
                      ...
                      <p className="faq-text">
                        ...
                        shipping typically takes 5-7 business days, while
                        express shipping takes 2-3 business days. International
                    ...
                    <label htmlFor="faq-b">
                      ...
                      <div className="faq-arrow"></div>
                      <p className="faq-text">
                        You can return any book within 30 days of purchase for a
                        full refund or exchange. The book must be in the same
                        condition as when you received it. Please contact our
                    ...
                    <label htmlFor="faq-c">
                      ...
                      <div className="faq-arrow"></div>
                      <p className="faq-text">
                        We sell both new and used books. The condition of each
                        book is clearly stated in the product description. Used
                        books may show signs of wear, but we ensure they are in
                    ...
                    <label htmlFor="faq-d">
                      ...
                      <p className="faq-text">
                        ...
                        track your order on our website or the carrier's
                        website.
                      </p>
                    </label>
                    ...
                    <label htmlFor="faq-e">
                      ...
                      <div className="faq-arrow"></div>
                      <p className="faq-text">
                        Yes, we offer gift wrapping services for an additional
                        fee. You can select the gift wrapping option during
                        checkout and include a personalized message if desired.
                      </p>
                    </label>
                    ...
                    <label htmlFor="faq-f">
                      ...
                      <div className="faq-arrow"></div>
                      <p className="faq-text">
                        Yes, we accept pre-orders for upcoming book releases.
                        Pre-ordered books will be shipped to you as soon as they
                        are released.
                      </p>
                    </label>
                    ...
                    <label htmlFor="faq-g">
                      ...
                      <p className="faq-text">
                        ...
                        All payments are processed securely to ensure your
                    ...
                    <label htmlFor="faq-h">
                      ...
                      <div className="faq-arrow"></div>
                      <p className="faq-text">
                        Yes, we offer discounts for bulk purchases. Please
                        contact our customer service team with your
                        requirements, and we will provide you with a custom
                        quote.
                      </p>
                    </label>
                  </div>
