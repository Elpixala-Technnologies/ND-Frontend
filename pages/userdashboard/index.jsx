                        ...
                        <div className='rounded-md p-2 flex flex-col md:flex-row gap-4'>
                            {UserAdddressData?.length > 0 ? (
                                UserAdddressData.map((addressValueData) => (
                                    <button
                                        key={addressValueData.id}
                                        onClick={() => handleUpdateAddressModal(addressValueData)}
                                ...
                                <Link href="/userdashboard/address-book/manage-address-book" className="border-2 border-black rounded-lg p-2 hover:text-white hover:bg-black">
                                        Add Address
                                    </Link>
                            )}
                        </div>
                ...
                <div className="flex flex-col items-start justify-start mt-10 w-auto p-5 border border-gray-300 rounded-lg mx-4 mb-16">
                    ...
                    <div className="my-2 text-lg w-full rounded-lg flex justify-between items-center gap-4">
                        ...
                        <div className="my-2 text-lg w-1/2 rounded-lg flex flex-col justify-start items-start">
                            ...
                            <span className="text-xl flex items-center border border-gray-300 p-2 w-full rounded-lg bg-white text-gray-400">
                                {UserAdddressData?.[0]?.phone || "Not Provided"}
                            </span>
                        </div>
                    </div>
                    ...
                    <div className='gap-4 grid grid-cols-2 my-4 w-1/2'>
                        <div>
                            ...
                            <span className="text-xl flex items-center border border-gray-300 p-2 w-full rounded-lg bg-white text-gray-400">
                                {UserAdddressData?.[0]?.address || "Not Provided"}
                            </span>
                        </div>
                        <div>
                            <span className="text-xl font-light">City: &nbsp;</span>
                            <span className="text-xl flex items-center border border-gray-300 p-2 w-full rounded-lg bg-white text-gray-400">
                                {UserAdddressData?.[0]?.city || "Not Provided"}
                            </span>
                        </div>
                        <div>
                            <span className="text-xl font-light">Country: &nbsp;</span>
                            <span className="text-xl flex items-center border border-gray-300 p-2 w-full rounded-lg bg-white text-gray-400">
                                {UserAdddressData?.[0]?.country || "Not Provided"}
                            </span>
                        </div>
                        <div>
                            <span className="text-xl font-light">State &nbsp;</span>
                            <span className="text-xl flex items-center border border-gray-300 p-2 w-full rounded-lg bg-white text-gray-400">
                                {UserAdddressData?.[0]?.state || "Not Provided"}
                            </span>
                        </div>
                        <div>
                            <span className="text-xl font-light">Zip: &nbsp;</span>
                            <span className="text-xl flex items-center border border-gray-300 p-2 w-full rounded-lg bg-white text-gray-400">
                                {UserAdddressData?.[0]?.zip || "Not Provided"}
                            </span>
                        </div>
                    </div>
                </div>
