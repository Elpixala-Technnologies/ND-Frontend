...
const HomeBestSeal = () => {
    ...
    {isLoading ? (
      ...
      bookData?.slice(0, 8).map((book) => (
        <div className="flex items-center justify-center w-full h-full" key={book._id}>
          <div className="best-seal w-fit">
            <div className="flip-card">
              <div className="flip-card-inner">
                ...
                <div className="flip-card-back flex flex-col items-center justify-center gap-2 relative">
                  ...
                  <span className="absolute bottom-2 left-2 text-gray-600 cursor-pointer">
